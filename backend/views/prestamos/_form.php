...
<?php
    ...
    $resultado = ArrayHelper::map($activeProductos, 'product_id', 'product_name');

    $quantity = Productos::findOne(['product_id' => 1]);
    //unset($resultado['1']);
    //$variable = 0;
...
<div class="prestamos-form">
    ...
    <?= $form->field($model, 'prestamo_comentario')
        ->textarea(['rows' => 3]) ?>

    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><i class="glyphicon glyphicon-shopping-cart"></i> Items to loan</h4>
            </div>
