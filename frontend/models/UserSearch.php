...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'colaborator_no', 'hoteles_hotel_id', 'status', 'created_at', 'updated_at'], 'integer'],
            [['username', 'first_name', 'last_name', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'user_type', 'user_image'], 'safe'],
        ];
    }
